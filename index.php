<?php
  $db = [
    [
      'domanda' => "Come state implementando la recente decisione della Corte di giustizia dell'Unione <br> europea (CGUE) relativa al diritto all'oblio?",
    ...
    [
      'domanda' => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono <br> inviate ai siti web?",
